...
import j2ee.ourteam.repositories.UserRepository;<<<<<<<HEAD=======
import lombok.AllArgsConstructor;

import org.springframework.beans.factory.annotation.Autowired;>>>>>>>feature/conversation_phuc
...
public class ConversationMemberServiceImpl implements IConversationMemberService {
    ...
    List<ConversationMemberDTO> dtos = members.stream()
        ...
        .collect(Collectors.toList());return ResponseDTO.success("Lấy danh sách thành viên thành công",dtos);
  }
